...
export var AnimeBannerFragmentDoc = gql(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    fragment AnimeBanner on Media {\n  id\n  title {\n    english\n    romaji\n  }\n  bannerImage\n  description\n  format\n  duration\n  meanScore\n  genres\n  season\n  startDate {\n    year\n  }\n}\n    "], ["\n    fragment AnimeBanner on Media {\n  id\n  title {\n    english\n    romaji\n  }\n  bannerImage\n  description\n  format\n  duration\n  meanScore\n  genres\n  season\n  startDate {\n    year\n  }\n}\n    "])));
export var AnimeInfoFragmentDoc = gql(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    fragment AnimeInfo on Media {\n  id\n  title {\n    english\n    romaji\n  }\n  coverImage {\n    color\n    medium\n    large\n  }\n  format\n  duration\n  meanScore\n  nextAiringEpisode {\n    airingAt\n    timeUntilAiring\n    episode\n  }\n}\n    "], ["\n    fragment AnimeInfo on Media {\n  id\n  title {\n    english\n    romaji\n  }\n  coverImage {\n    color\n    medium\n    large\n  }\n  format\n  duration\n  meanScore\n  nextAiringEpisode {\n    airingAt\n    timeUntilAiring\n    episode\n  }\n}\n    "])));
export var GetAnimeBannerDocument = gql(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    query getAnimeBanner($id: Int) {\n  Media(id: $id, type: ANIME) {\n    ...AnimeBanner\n  }\n}\n    ", ""], ["\n    query getAnimeBanner($id: Int) {\n  Media(id: $id, type: ANIME) {\n    ...AnimeBanner\n  }\n}\n    ", ""])), AnimeBannerFragmentDoc);
export var GetAnimeInfoDocument = gql(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n    query getAnimeInfo($id: Int) {\n  Media(id: $id, type: ANIME) {\n    ...AnimeInfo\n  }\n}\n    ", ""], ["\n    query getAnimeInfo($id: Int) {\n  Media(id: $id, type: ANIME) {\n    ...AnimeInfo\n  }\n}\n    ", ""])), AnimeInfoFragmentDoc);
export var GetAnimeByIdsDocument = gql(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n    query getAnimeByIds($perPage: Int, $page: Int, $ids: [Int]) {\n  Page(perPage: $perPage, page: $page) {\n    media(id_in: $ids) {\n      ...AnimeInfo\n    }\n  }\n}\n    ", ""], ["\n    query getAnimeByIds($perPage: Int, $page: Int, $ids: [Int]) {\n  Page(perPage: $perPage, page: $page) {\n    media(id_in: $ids) {\n      ...AnimeInfo\n    }\n  }\n}\n    ", ""])), AnimeInfoFragmentDoc);
export var GetAnimeTitleDocument = gql(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n    query getAnimeTitle($id: Int) {\n  Media(id: $id, type: ANIME) {\n    title {\n      romaji\n      english\n    }\n  }\n}\n    "], ["\n    query getAnimeTitle($id: Int) {\n  Media(id: $id, type: ANIME) {\n    title {\n      romaji\n      english\n    }\n  }\n}\n    "])));
export var GetPopularBannerDocument = gql(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n    query getPopularBanner($seasonYear: Int) {\n  Media(type: ANIME, sort: POPULARITY_DESC, seasonYear: $seasonYear) {\n    ...AnimeBanner\n  }\n}\n    ", ""], ["\n    query getPopularBanner($seasonYear: Int) {\n  Media(type: ANIME, sort: POPULARITY_DESC, seasonYear: $seasonYear) {\n    ...AnimeBanner\n  }\n}\n    ", ""])), AnimeBannerFragmentDoc);
export var SearchAnimeDocument = gql(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n    query searchAnime($page: Int, $perPage: Int, $keyword: String) {\n  Page(perPage: $perPage, page: $page) {\n    media(type: ANIME, search: $keyword) {\n      ...AnimeInfo\n    }\n  }\n}\n    ", ""], ["\n    query searchAnime($page: Int, $perPage: Int, $keyword: String) {\n  Page(perPage: $perPage, page: $page) {\n    media(type: ANIME, search: $keyword) {\n      ...AnimeInfo\n    }\n  }\n}\n    ", ""])), AnimeInfoFragmentDoc);
export var SearchGenreDocument = gql(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n    query searchGenre($page: Int, $perPage: Int, $genre: String) {\n  Page(perPage: $perPage, page: $page) {\n    media(type: ANIME, genre: $genre, sort: POPULARITY_DESC) {\n      ...AnimeInfo\n    }\n  }\n}\n    ", ""], ["\n    query searchGenre($page: Int, $perPage: Int, $genre: String) {\n  Page(perPage: $perPage, page: $page) {\n    media(type: ANIME, genre: $genre, sort: POPULARITY_DESC) {\n      ...AnimeInfo\n    }\n  }\n}\n    ", ""])), AnimeInfoFragmentDoc);
export var GetListDocument = gql(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n    query getList($perPage: Int, $page: Int, $sort: [MediaSort]) {\n  Page(perPage: $perPage, page: $page) {\n    media(sort: $sort, type: ANIME) {\n      ...AnimeInfo\n    }\n  }\n}\n    ", ""], ["\n    query getList($perPage: Int, $page: Int, $sort: [MediaSort]) {\n  Page(perPage: $perPage, page: $page) {\n    media(sort: $sort, type: ANIME) {\n      ...AnimeInfo\n    }\n  }\n}\n    ", ""])), AnimeInfoFragmentDoc);
export var IndexPageDocument = gql(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n    query indexPage($perPage: Int, $page: Int, $seasonYear: Int) {\n  banner: Media(type: ANIME, sort: POPULARITY_DESC, seasonYear: $seasonYear) {\n    ...AnimeBanner\n  }\n  trending: Page(perPage: $perPage, page: $page) {\n    media(sort: TRENDING_DESC, type: ANIME) {\n      ...AnimeInfo\n    }\n  }\n  popular: Page(perPage: $perPage, page: $page) {\n    media(sort: POPULARITY_DESC, type: ANIME) {\n      ...AnimeInfo\n    }\n  }\n  topRated: Page(perPage: $perPage, page: $page) {\n    media(sort: SCORE_DESC, type: ANIME) {\n      ...AnimeInfo\n    }\n  }\n}\n    ", "\n", ""], ["\n    query indexPage($perPage: Int, $page: Int, $seasonYear: Int) {\n  banner: Media(type: ANIME, sort: POPULARITY_DESC, seasonYear: $seasonYear) {\n    ...AnimeBanner\n  }\n  trending: Page(perPage: $perPage, page: $page) {\n    media(sort: TRENDING_DESC, type: ANIME) {\n      ...AnimeInfo\n    }\n  }\n  popular: Page(perPage: $perPage, page: $page) {\n    media(sort: POPULARITY_DESC, type: ANIME) {\n      ...AnimeInfo\n    }\n  }\n  topRated: Page(perPage: $perPage, page: $page) {\n    media(sort: SCORE_DESC, type: ANIME) {\n      ...AnimeInfo\n    }\n  }\n}\n    ", "\n", ""])), AnimeBannerFragmentDoc, AnimeInfoFragmentDoc);
export var AnimePageDocument = gql(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n    query animePage($id: Int, $perPage: Int) {\n  Media(id: $id, type: ANIME) {\n    status\n    ...AnimeInfo\n    ...AnimeBanner\n  }\n  recommended: Page(perPage: $perPage) {\n    recommendations(mediaId: $id, sort: RATING_DESC) {\n      mediaRecommendation {\n        ...AnimeInfo\n      }\n    }\n  }\n}\n    ", "\n", ""], ["\n    query animePage($id: Int, $perPage: Int) {\n  Media(id: $id, type: ANIME) {\n    status\n    ...AnimeInfo\n    ...AnimeBanner\n  }\n  recommended: Page(perPage: $perPage) {\n    recommendations(mediaId: $id, sort: RATING_DESC) {\n      mediaRecommendation {\n        ...AnimeInfo\n      }\n    }\n  }\n}\n    ", "\n", ""])), AnimeInfoFragmentDoc, AnimeBannerFragmentDoc);
export var WatchPageDocument = gql(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n    query watchPage($id: Int, $perPage: Int) {\n  anime: Media(id: $id) {\n    ...AnimeBanner\n    ...AnimeInfo\n  }\n  recommended: Page(perPage: $perPage) {\n    recommendations(mediaId: $id, sort: RATING_DESC) {\n      mediaRecommendation {\n        ...AnimeBanner\n        ...AnimeInfo\n      }\n    }\n  }\n}\n    ", "\n", ""], ["\n    query watchPage($id: Int, $perPage: Int) {\n  anime: Media(id: $id) {\n    ...AnimeBanner\n    ...AnimeInfo\n  }\n  recommended: Page(perPage: $perPage) {\n    recommendations(mediaId: $id, sort: RATING_DESC) {\n      mediaRecommendation {\n        ...AnimeBanner\n        ...AnimeInfo\n      }\n    }\n  }\n}\n    ", "\n", ""])), AnimeBannerFragmentDoc, AnimeInfoFragmentDoc);
...
export function getSdk(client, withWrapper) {
    ...
    return {
        getAnimeBanner: function (variables, requestHeaders) {
            return withWrapper(function (wrappedRequestHeaders) { return client.request(GetAnimeBannerDocument, variables, __assign(__assign({}, requestHeaders), wrappedRequestHeaders)); }, 'getAnimeBanner', 'query');
        },
        getAnimeInfo: function (variables, requestHeaders) {
            return withWrapper(function (wrappedRequestHeaders) { return client.request(GetAnimeInfoDocument, variables, __assign(__assign({}, requestHeaders), wrappedRequestHeaders)); }, 'getAnimeInfo', 'query');
        },
        getAnimeByIds: function (variables, requestHeaders) {
            return withWrapper(function (wrappedRequestHeaders) { return client.request(GetAnimeByIdsDocument, variables, __assign(__assign({}, requestHeaders), wrappedRequestHeaders)); }, 'getAnimeByIds', 'query');
        },
        getAnimeTitle: function (variables, requestHeaders) {
            return withWrapper(function (wrappedRequestHeaders) { return client.request(GetAnimeTitleDocument, variables, __assign(__assign({}, requestHeaders), wrappedRequestHeaders)); }, 'getAnimeTitle', 'query');
        },
        getPopularBanner: function (variables, requestHeaders) {
            return withWrapper(function (wrappedRequestHeaders) { return client.request(GetPopularBannerDocument, variables, __assign(__assign({}, requestHeaders), wrappedRequestHeaders)); }, 'getPopularBanner', 'query');
        },
        searchAnime: function (variables, requestHeaders) {
            return withWrapper(function (wrappedRequestHeaders) { return client.request(SearchAnimeDocument, variables, __assign(__assign({}, requestHeaders), wrappedRequestHeaders)); }, 'searchAnime', 'query');
        },
        searchGenre: function (variables, requestHeaders) {
            return withWrapper(function (wrappedRequestHeaders) { return client.request(SearchGenreDocument, variables, __assign(__assign({}, requestHeaders), wrappedRequestHeaders)); }, 'searchGenre', 'query');
        },
        getList: function (variables, requestHeaders) {
            return withWrapper(function (wrappedRequestHeaders) { return client.request(GetListDocument, variables, __assign(__assign({}, requestHeaders), wrappedRequestHeaders)); }, 'getList', 'query');
        },
        indexPage: function (variables, requestHeaders) {
            return withWrapper(function (wrappedRequestHeaders) { return client.request(IndexPageDocument, variables, __assign(__assign({}, requestHeaders), wrappedRequestHeaders)); }, 'indexPage', 'query');
        },
        animePage: function (variables, requestHeaders) {
            return withWrapper(function (wrappedRequestHeaders) { return client.request(AnimePageDocument, variables, __assign(__assign({}, requestHeaders), wrappedRequestHeaders)); }, 'animePage', 'query');
        },
        watchPage: function (variables, requestHeaders) {
            return withWrapper(function (wrappedRequestHeaders) { return client.request(WatchPageDocument, variables, __assign(__assign({}, requestHeaders), wrappedRequestHeaders)); }, 'watchPage', 'query');
        }
    };
}
